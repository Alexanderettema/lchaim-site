<?php
    ...
    while ( have_posts() ) : the_post();
        if( !is_sticky() ) {
            ...
            $pofo_hide_icon_default = get_theme_mod( 'pofo_hide_icon_default', '1' );
            ...
            echo '<div class="blog-post-style-default blog-post-style3 '.$class_column.$pofo_post_classes_infinite_scroll.'"'.$pofo_animation_delay_attr.'>';
                echo '<div '.$pofo_post_classes.'>';
                    echo '<div class="grid-item">';
                        echo '<div class="blog-post bg-light-gray inner-match-height">';
                                        ...
                                        if( has_post_thumbnail() ) {
                                            echo '<div class="blog-post-images overflow-hidden position-relative text-center">';
                                                ...
                                                echo '<a href="'.esc_url( $page_url ).'">';
                                                    ...
                                                    echo '<div class="blog-hover-icon">';
                                                        if( $pofo_hide_icon_default == 1 ){
                                                            echo '<span class="text-extra-large font-weight-300">+</span>';
                                                        }
                                                    echo '</div>';
                                                echo '</a>';
                                            echo '</div>';
                            ...
                            echo '<div class="post-details padding-ten-all sm-padding-20px-all pofo-default-post-description pofo-default-box-background-color xs-text-center">';
                                echo '<div class="blog-hover-color"></div>';
                                if( $pofo_show_post_title_default == 1 ){
                                    $page_url = get_permalink();
                                    echo '<a class="alt-font post-title text-medium text-extra-dark-gray display-block entry-title'.$pofo_title_dynamic_font_size.$pofo_blog_post_title_text_transform_default.'" href="'.esc_url( $page_url ).'"'.$pofo_title_style_attr.'>'.get_the_title().'</a>';
                                }
                                if( $pofo_show_excerpt_default == 1 ){
                                    ...
                                    echo '<div class="entry-content no-margin-bottom margin-15px-top">'.$show_excerpt_grid.'</div>';
                                ...
                                if( $pofo_show_separator_default == 1 ){
                                    echo '<div class="pofo-post-sepataror separator-line-horrizontal-full bg-medium-gray margin-20px-top sm-margin-15px-top"'.$sep_style_attr.'></div>';
                                }
                                if( !empty( $author_date_array ) ){
                                    echo '<div class="author text-extra-small text-medium-gray display-block margin-20px-top sm-margin-15px-top">';
                                        echo '<span class="text-medium-gray text-extra-small display-inline-block'.$pofo_blog_post_meta_text_transform_default.'">'.implode( '<span class="blog-separator vertical-align-middle">|</span>', $author_date_array ).'</span>';
                                    echo '</div>';
                                }
