...
if ( !defined( 'ABSPATH' ) ) { exit; }
    ...
    $pofo_image = pofo_get_image_id_by_url( pofo_option('pofo_single_post_title_bg_image','') );
    ...
    if( $pofo_disable_single_post_title_image == 1 || $pofo_disable_single_post_title_image == '' ){
        ...
        $pofo_single_post_title_bg_image = ( $pofo_image_url[0] ) ? ' style="background-image: url('.esc_url( $pofo_image_url[0] ).'); background-repeat: no-repeat; "': '';
        $parallax_effect = pofo_option('pofo_single_post_title_parallax_effect', '0.5');
        $pofo_single_post_title_parallax_effect = ( !empty( $parallax_effect ) && $parallax_effect != 'no-parallax' ) ? ' data-stellar-background-ratio="'.$parallax_effect.'"': '';
    ...
    switch ( $pofo_single_post_title_style ) {
        case 'page-title-style-1':
            echo '<section class="wow fadeIn bg-light-gray padding-50px-tb xs-padding-30px-tb page-title-small pofo-single-post-title-bg top-space '.$pofo_single_post_title_style.'">';
                echo '<div class="container">';
                    echo '<div class="row equalize sm-equalize-auto">';
                        if( $pofo_single_post_title != '' || $pofo_single_post_title_subtitle != '' ){
                            echo '<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 display-table">';
                                echo '<div class="display-table-cell vertical-align-middle text-left sm-text-center">';
                                    if( $pofo_single_post_title ){
                                        echo '<h1 class="alt-font text-extra-dark-gray font-weight-600 no-margin-bottom pofo-single-post-title '.$pofo_single_post_title_text_transform.'">'.esc_attr( $pofo_single_post_title ).'</h1>';
                                    }
                                    if( $pofo_single_post_title_subtitle && ( $pofo_disable_single_post_subtitle == 1 || $pofo_disable_single_post_subtitle == '') ){
                                        echo '<span class="display-block margin-5px-top alt-font pofo-single-post-subtitle">'.esc_attr( $pofo_single_post_title_subtitle ).'</span>';
                                    }
                                echo '</div>';
                            echo '</div>';
                        }
        ...
        case 'page-title-style-2':
            echo '<section class="wow fadeIn bg-light-gray padding-50px-tb xs-padding-30px-tb small-single-post-title pofo-single-post-title-bg top-space '.$pofo_single_post_title_style.'">';
                echo '<div class="container">';
                    echo '<div class="row equalize sm-equalize-auto">';
                        if( !empty( $pofo_post_meta_array ) ){
        ...
        case 'page-title-style-3':
            echo '<section class="wow fadeIn bg-light-gray padding-100px-tb sm-padding-60px-tb xs-padding-30px-tb pofo-single-post-title-bg top-space '.$pofo_single_post_title_style.'">';
                echo '<div class="container">';
                    echo '<div class="row">';
                        if( $pofo_single_post_title != '' || $pofo_single_post_title_subtitle != '' || !empty( $pofo_post_meta_array ) ){
                            echo '<div class="col-md-12 col-sm-12 col-xs-12 display-table page-title-medium">';
                                echo '<div class="display-table-cell vertical-align-middle text-center">';
                                    if( $pofo_single_post_title ){
                                        echo '<h1 class="alt-font text-extra-dark-gray font-weight-600 no-margin pofo-single-post-title '.$pofo_single_post_title_text_transform.'">'.esc_attr( $pofo_single_post_title ).'</h1>';
                                    }
                                    if( $pofo_single_post_title_subtitle && ( $pofo_disable_single_post_subtitle == 1 || $pofo_disable_single_post_subtitle == '') ){
                                        echo '<span class="display-block center-col margin-10px-top alt-font pofo-single-post-subtitle">'.esc_attr( $pofo_single_post_title_subtitle ).'</span>';
                                    }
                                    if( !empty( $pofo_post_meta_array ) ){
        ...
        case 'page-title-style-4':
            echo '<section class="wow fadeIn pofo-single-post-title-bg '.$pofo_single_post_title_style.$pofo_single_post_title_parallax.$srcset_classes.'"'.$pofo_single_post_title_parallax_effect.$pofo_single_post_title_bg_image.$srcset_data.'>';
                    ...
                    echo '<div class="row">';
                        if( $pofo_single_post_title != '' || $pofo_single_post_title_subtitle != '' || !empty( $pofo_post_meta_array ) ){
                            echo '<div class="col-md-12 col-sm-12 col-xs-12 one-second-screen display-table extra-small-screen page-title-medium center-col">';
                                echo '<div class="display-table-cell vertical-align-middle text-center">';
                                    if( $pofo_single_post_title ){
                                        echo '<h1 class="alt-font text-white font-weight-600 no-margin letter-spacing-1 pofo-single-post-title '.$pofo_single_post_title_text_transform.'">'.esc_attr( $pofo_single_post_title ).'</h1>';
                                    }
                                    if( $pofo_single_post_title_subtitle && ( $pofo_disable_single_post_subtitle == 1 || $pofo_disable_single_post_subtitle == '') ){
                                        echo '<span class="display-block margin-10px-top text-extra-small alt-font pofo-single-post-subtitle">'.esc_attr( $pofo_single_post_title_subtitle ).'</span>';
                                    }
                                    if( !empty( $pofo_post_meta_array ) ){
                                        echo '<div class="breadcrumb text-small alt-font no-margin-bottom display-block margin-15px-top">';
                                            echo '<ul class="pofo-single-post-title-breadcrumb-single '.$pofo_single_post_title_style.' '.$pofo_single_post_meta_text_transform.'">';
        ...
        case 'page-title-style-5':
            echo '<section class="wow fadeIn bg-extra-dark-gray pofo-single-post-title-bg '.$pofo_single_post_title_style.$pofo_single_post_title_parallax.$srcset_classes.'"'.$pofo_single_post_title_parallax_effect.$pofo_single_post_title_bg_image.$srcset_data.'>';
                echo wp_kses_post( $pofo_single_post_title_bg_image_overlay );
                echo '<div class="container">';
                    echo '<div class="row">';
                        if( $pofo_single_post_title != '' || $pofo_single_post_title_subtitle != '' || !empty( $pofo_post_meta_array ) ){
                            echo '<div class="col-md-12 col-sm-12 col-xs-12 extra-small-screen display-table page-title-extra-small">';
                                echo '<div class="display-table-cell vertical-align-middle text-center">';
                                    if( $pofo_single_post_title ){
                                        echo '<h1 class="alt-font text-white opacity7 margin-10px-bottom pofo-single-post-title '.$pofo_single_post_title_text_transform.'">'.esc_attr( $pofo_single_post_title ).'</h1>';
                                    }
                                    if( $pofo_single_post_title_subtitle && ( $pofo_disable_single_post_subtitle == 1 || $pofo_disable_single_post_subtitle == '') ){
                                        echo '<h2 class="text-white alt-font font-weight-600 width-55 sm-width-65 center-col xs-width-100 letter-spacing-minus-1 line-height-50 sm-line-height-45 xs-line-height-30 pofo-single-post-subtitle">'.esc_attr( $pofo_single_post_title_subtitle ).'</h2>';
                                    }
                                    if( !empty( $pofo_post_meta_array ) ){
        ...
        case 'page-title-style-6':
            echo '<section class="wow fadeIn pofo-single-post-title-bg top-space '.$pofo_single_post_title_style.$pofo_single_post_title_parallax.$srcset_classes.'"'.$pofo_single_post_title_parallax_effect.$pofo_single_post_title_bg_image.$srcset_data.'>';
                echo wp_kses_post( $pofo_single_post_title_bg_image_overlay );
                echo '<div class="container">';
                    echo '<div class="row">';
                    if( $pofo_single_post_title != '' || $pofo_single_post_title_subtitle != '' || !empty( $pofo_post_meta_array ) ){
                        echo '<div class="col-md-12 col-sm-12 col-xs-12 display-table page-title-large">';
                            echo '<div class="display-table-cell vertical-align-middle text-center padding-30px-tb">';
                                ...
                                if( $pofo_single_post_title_subtitle && ( $pofo_disable_single_post_subtitle == 1 || $pofo_disable_single_post_subtitle == '') ){
                                    echo '<span class="display-block text-white opacity6 alt-font margin-5px-bottom pofo-single-post-subtitle">'.esc_attr( $pofo_single_post_title_subtitle ).'</span>';
                                }
                                if( $pofo_single_post_title ){
                                    echo '<h1 class="alt-font text-white font-weight-600 no-margin-bottom pofo-single-post-title '.$pofo_single_post_title_text_transform.'">'.esc_attr( $pofo_single_post_title ).'</h1>';
                                }
                            echo '</div>';
                        echo '</div>';
                    }
        ...
        case 'page-title-style-7':
            ...
            echo '<section class="no-padding one-third-screen position-relative wow fadeIn pofo-single-post-title-bg '.$pofo_single_post_title_style.'">';
                echo wp_kses_post( $pofo_single_post_title_bg_image_overlay );
                echo '<div class="container">';
                    echo '<div class="row">';
                        if( $pofo_single_post_title != '' || $pofo_single_post_title_subtitle != '' || !empty( $pofo_post_meta_array ) ){
                            echo '<div class="col-md-12 col-sm-12 col-xs-12 display-table one-third-screen z-index-2 page-title-large">';
                                echo '<div class="display-table-cell vertical-align-middle text-center">';
                                    if( $pofo_single_post_title_subtitle && ( $pofo_disable_single_post_subtitle == 1 || $pofo_disable_single_post_subtitle == '') ){
                                        echo '<span class="display-block text-white opacity6 margin-10px-bottom alt-font pofo-single-post-subtitle">'.esc_attr( $pofo_single_post_title_subtitle ).'</span>';
                                    }
                                    if( $pofo_single_post_title ){
                                        echo '<h1 class="alt-font text-white font-weight-600 width-55 sm-width-80 xs-width-100 center-col no-margin-bottom pofo-single-post-title '.$pofo_single_post_title_text_transform.'">'.esc_attr( $pofo_single_post_title ).'</h1>';
                                    }
                                    if( !empty( $pofo_post_meta_array ) ){
                                        echo '<div class="breadcrumb text-small alt-font no-margin-bottom display-block margin-15px-top">';
                                            echo '<ul class="pofo-single-post-title-breadcrumb-single '.$pofo_single_post_title_style.' '.$pofo_single_post_meta_text_transform.'">';
        ...
        case 'page-title-style-8':
            ...
            echo '<section class="no-padding one-third-screen position-relative wow fadeIn pofo-single-post-title-bg '.$pofo_single_post_title_style.$pofo_single_post_title_parallax.$srcset_classes.'"'.$pofo_single_post_title_parallax_effect.$pofo_single_post_title_bg_image.$srcset_data.'>';
                echo wp_kses_post( $pofo_single_post_title_bg_image_overlay );
                echo '<div class="container">';
                    echo '<div class="row">';
                        if( $pofo_single_post_title != '' || $pofo_single_post_title_subtitle != ''){
                            echo '<div class="col-md-12 col-sm-12 col-xs-12 z-index-3 display-table one-third-screen page-title-medium">';
                                echo '<div class="display-table-cell vertical-align-middle text-center">';
                                    if( $pofo_single_post_title_subtitle && ( $pofo_disable_single_post_subtitle == 1 || $pofo_disable_single_post_subtitle == '') ){
                                        echo '<span class="margin-5px-bottom display-block alt-font text-medium-gray pofo-single-post-subtitle">'.esc_attr( $pofo_single_post_title_subtitle ).'</span>';
                                    }
                                    if( $pofo_single_post_title ){
                                        echo '<h1 class="text-white alt-font font-weight-600 letter-spacing-minus-1 pofo-single-post-title '.$pofo_single_post_title_text_transform.'">'.esc_attr( $pofo_single_post_title ).'</h1>';
                                    }
                                    if( !empty( $pofo_post_meta_array ) ){
                                        echo '<div class="breadcrumb text-small alt-font no-margin-bottom display-block">';
                                            echo '<ul class="pofo-single-post-title-breadcrumb-single '.$pofo_single_post_title_style.' '.$pofo_single_post_meta_text_transform.'">';
                ...
                if( $pofo_single_post_title_video_type == 'self' && ( $pofo_single_post_title_video_mp4 || $pofo_single_post_title_video_ogg || $pofo_single_post_title_video_webm )){
                    echo '<video autoplay'.$pofo_single_post_loop_video.$pofo_single_post_mute_video.' class="html-video z-index-1"'.$pofo_poster_image.'>';
                    ...
                    echo '<div class="external-fit-videos fit-videos width-100">';
                        echo '<embed width="560" height="315" src="'.$pofo_single_post_title_video_youtube.'" frameborder="0" allowfullscreen></embed>';
                    echo '</div>';
                }
            echo '</section>';
            if( $pofo_disable_breadcrumb == 1 ){
        ...
        case 'page-title-style-9':
            echo '<section class="wow fadeIn bg-light-gray padding-35px-tb page-title-small pofo-single-post-title-bg top-space '.$pofo_single_post_title_style.'">';
                echo '<div class="container">';
                    echo '<div class="row equalize sm-equalize-auto">';
                        if( $pofo_single_post_title != '' ){
                            echo '<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 display-table">';
                    ...
                    echo '<div class="row">';
                        if( $pofo_single_post_title != '' || $pofo_single_post_title_subtitle != '' || !empty( $pofo_post_meta_array ) ){
                            echo '<div class="col-md-12 col-sm-12 col-xs-12 one-second-screen display-table extra-small-screen page-title-large center-col">';
                                echo '<div class="display-table-cell vertical-align-middle text-center">';
                                    if( $pofo_single_post_title ){
                                        echo '<h1 class="text-white alt-font font-weight-600 letter-spacing-minus-1 margin-10px-bottom pofo-single-post-title '.$pofo_single_post_title_text_transform.'">'.esc_attr( $pofo_single_post_title ).'</h1>';
                                    }
                                    if( $pofo_single_post_title_subtitle && ( $pofo_disable_single_post_subtitle == 1 || $pofo_disable_single_post_subtitle == '') ){
                                        echo '<span class="text-white alt-font margin-15px-bottom pofo-single-post-subtitle display-block opacity6">'.esc_attr( $pofo_single_post_title_subtitle ).'</span>';
                                    }
                                    if( !empty( $pofo_post_meta_array ) ){
                                        echo '<div class="breadcrumb text-small alt-font no-margin-bottom display-block">';
                                            echo '<ul class="pofo-single-post-title-breadcrumb-single '.$pofo_single_post_title_style.' '.$pofo_single_post_meta_text_transform.'">';
