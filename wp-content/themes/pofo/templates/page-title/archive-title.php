...
if ( !defined( 'ABSPATH' ) ) { exit; }
    ...
    $pofo_image = pofo_get_image_id_by_url( pofo_category_title_option('pofo_archive_title_bg_image',''));
    ...
    $pofo_archive_title_bg_image = ( $pofo_image_url[0] ) ? ' style="background-image: url('.esc_url( $pofo_image_url[0] ).'); background-repeat: no-repeat; "': '';

    $parallax_effect = pofo_option('pofo_archive_title_parallax_effect', '0.5');
    $pofo_archive_title_parallax_effect = ( !empty( $parallax_effect ) && $parallax_effect != 'no-parallax' ) ? ' data-stellar-background-ratio="'.$parallax_effect.'"': '';
    ...
    switch ( $pofo_archive_title_style ) {
        case 'page-title-style-1':
            echo '<section class="wow fadeIn bg-light-gray padding-50px-tb xs-padding-30px-tb page-title-small pofo-archive-title-bg top-space '.$pofo_archive_title_style.'">';
                echo '<div class="container">';
                    echo '<div class="row equalize sm-equalize-auto">';
                        if( $pofo_archive_title != '' || $pofo_archive_title_subtitle != '' ){
                            echo '<div class="col-lg-7 col-md-6 col-sm-12 col-xs-12 display-table">';
                                echo '<div class="display-table-cell vertical-align-middle text-left sm-text-center">';
                                    if( $pofo_archive_title ){
                                        echo '<h1 class="alt-font text-extra-dark-gray font-weight-600 no-margin-bottom pofo-archive-title '.$pofo_archive_title_text_transform.'">'.esc_attr( $pofo_archive_title ).'</h1>';
                                    }
                                    if( $pofo_archive_title_subtitle ){
                                        echo '<span class="display-block margin-5px-top alt-font pofo-archive-subtitle">'.esc_attr( $pofo_archive_title_subtitle ).'</span>';
                                    }
                                echo '</div>';
                            echo '</div>';
                        }
                        if( $pofo_disable_breadcrumb == 1 ){
                            echo '<div class="col-lg-5 col-md-6 col-sm-12 col-xs-12 display-table text-right sm-text-center sm-margin-15px-top">';
                                echo '<div class="display-table-cell vertical-align-middle breadcrumb text-small alt-font">';
                                    echo '<ul class="pofo-archive-title-breadcrumb" itemscope="" itemtype="http://schema.org/BreadcrumbList">';
        ...
        case 'page-title-style-2':
            echo '<section class="wow fadeIn bg-light-gray padding-50px-tb xs-padding-30px-tb small-page-title pofo-archive-title-bg top-space '.$pofo_archive_title_style.'">';
                echo '<div class="container">';
                    echo '<div class="row equalize sm-equalize-auto">';
                        if( $pofo_disable_breadcrumb == 1 ){
        ...
        case 'page-title-style-3':
            echo '<section class="wow fadeIn bg-light-gray padding-100px-tb sm-padding-60px-tb xs-padding-30px-tb pofo-archive-title-bg top-space '.$pofo_archive_title_style.'">';
                echo '<div class="container">';
                    echo '<div class="row">';
                        if( $pofo_archive_title != '' || $pofo_archive_title_subtitle != '' ){
                            echo '<div class="col-md-12 col-sm-12 col-xs-12 display-table page-title-medium">';
                                echo '<div class="display-table-cell vertical-align-middle text-center">';
                                    if( $pofo_archive_title ){
                                        echo '<h1 class="alt-font text-extra-dark-gray font-weight-600 no-margin pofo-archive-title '.$pofo_archive_title_text_transform.'">'.esc_attr( $pofo_archive_title ).'</h1>';
                                    }
                                    if( $pofo_archive_title_subtitle ){
                                        echo '<span class="display-block center-col margin-10px-top alt-font pofo-archive-subtitle">'.esc_attr( $pofo_archive_title_subtitle ).'</span>';
                                    }
                                echo '</div>';
                            echo '</div>';
                        }
            ...
            echo '</section>';
            if( $pofo_disable_breadcrumb == 1 ){
                echo '<section class="wow fadeIn padding-20px-tb border-bottom border-color-extra-light-gray pofo-archive-breadcrumb">';
                    echo '<div class="container">';
                        echo '<div class="row">';
        ...
        case 'page-title-style-4':
            echo '<section class="wow fadeIn pofo-archive-title-bg '.$pofo_archive_title_style.$pofo_archive_title_parallax.$srcset_classes.'"'.$pofo_archive_title_parallax_effect.$pofo_archive_title_bg_image.$srcset_data.'>';
                    ...
                    echo '<div class="row">';
                        if( $pofo_archive_title != '' || $pofo_archive_title_subtitle != '' ){
                            echo '<div class="col-md-12 col-sm-12 col-xs-12 display-table extra-small-screen page-title-medium center-col">';
                                echo '<div class="display-table-cell vertical-align-middle text-center">';
                                    if( $pofo_archive_title ){
                                        echo '<h1 class="alt-font text-white font-weight-600 no-margin letter-spacing-1 pofo-archive-title '.$pofo_archive_title_text_transform.'">'.esc_attr( $pofo_archive_title ).'</h1>';
                                    }
                                    if( $pofo_archive_title_subtitle ){
                                        echo '<span class="display-block margin-10px-top text-extra-small alt-font pofo-archive-subtitle">'.esc_attr( $pofo_archive_title_subtitle ).'</span>';
                                    }
                                echo '</div>';
                            echo '</div>';
                        }
        ...
        case 'page-title-style-5':
            echo '<section class="wow fadeIn bg-extra-dark-gray pofo-archive-title-bg '.$pofo_archive_title_style.$pofo_archive_title_parallax.$srcset_classes.'"'.$pofo_archive_title_parallax_effect.$pofo_archive_title_bg_image.$srcset_data.'>';
                echo wp_kses_post( $pofo_archive_title_bg_image_overlay );
                echo '<div class="container">';
                    echo '<div class="row">';
                        if( $pofo_archive_title != '' || $pofo_archive_title_subtitle != '' ){
                            echo '<div class="col-md-12 col-sm-12 col-xs-12 extra-small-screen display-table page-title-extra-small">';
                                echo '<div class="display-table-cell vertical-align-middle text-center">';
                                    if( $pofo_archive_title ){
                                        echo '<h1 class="alt-font text-white opacity7 margin-10px-bottom pofo-archive-title '.$pofo_archive_title_text_transform.'">'.esc_attr( $pofo_archive_title ).'</h1>';
                                    }
                                    if( $pofo_archive_title_subtitle ){
                                        echo '<h2 class="text-white alt-font font-weight-500 width-55 sm-width-65 center-col xs-width-100 letter-spacing-minus-1 line-height-50 sm-line-height-45 xs-line-height-30 pofo-archive-subtitle">'.esc_attr( $pofo_archive_title_subtitle ).'</h2>';
                                    }
                                echo '</div>';
                            echo '</div>';
                        }
        ...
        case 'page-title-style-6':
            echo '<section class="wow fadeIn pofo-archive-title-bg top-space '.$pofo_archive_title_style.$pofo_archive_title_parallax.$srcset_classes.'"'.$pofo_archive_title_parallax_effect.$pofo_archive_title_bg_image.$srcset_data.'>';
                echo wp_kses_post( $pofo_archive_title_bg_image_overlay );
                echo '<div class="container">';
                    echo '<div class="row">';
                    if( $pofo_archive_title != '' || $pofo_archive_title_subtitle != '' ){
                        echo '<div class="col-md-12 col-sm-12 col-xs-12 display-table page-title-large">';
                            echo '<div class="display-table-cell vertical-align-middle text-center padding-30px-tb">';
                                if( $pofo_archive_title_subtitle ){
                                    echo '<span class="display-block text-white opacity6 alt-font margin-5px-bottom pofo-archive-subtitle">'.esc_attr( $pofo_archive_title_subtitle ).'</span>';
                                }
                                if( $pofo_archive_title ){
                                    echo '<h1 class="alt-font text-white font-weight-600 no-margin-bottom pofo-archive-title '.$pofo_archive_title_text_transform.'">'.esc_attr( $pofo_archive_title ).'</h1>';
                                }
                            echo '</div>';
                        echo '</div>';
                    }
        ...
        case 'page-title-style-7':
            $pofo_archive_title_bg_image_overlay = ( $pofo_archive_title_opacity != '' ) ? '<div class="opacity-medium z-index-1 bg-extra-dark-gray bg-archive-opacity-color"'.$pofo_archive_title_opacity_style.'></div>' : '';
            echo '<section class="no-padding one-third-screen position-relative wow fadeIn pofo-archive-title-bg '.$pofo_archive_title_style.'">';
                echo wp_kses_post( $pofo_archive_title_bg_image_overlay );
                echo '<div class="container">';
                    echo '<div class="row">';
                        if( $pofo_archive_title != '' || $pofo_archive_title_subtitle != '' ){
                            echo '<div class="col-md-12 col-sm-12 col-xs-12 display-table one-third-screen z-index-2 page-title-large">';
                                echo '<div class="display-table-cell vertical-align-middle text-center">';
                                    if( $pofo_archive_title_subtitle ){
                                        echo '<span class="display-block text-white opacity6 margin-10px-bottom alt-font pofo-archive-subtitle">'.esc_attr( $pofo_archive_title_subtitle ).'</span>';
                                    }
                                    if( $pofo_archive_title ){
                                        echo '<h1 class="alt-font text-white font-weight-600 width-55 sm-width-80 xs-width-100 center-col no-margin-bottom pofo-archive-title '.$pofo_archive_title_text_transform.'">'.esc_attr( $pofo_archive_title ).'</h1>';
                                    }
                                echo '</div>';
                            echo '</div>';
                        }
        ...
        case 'page-title-style-8':
            $pofo_archive_title_bg_image_overlay = ( $pofo_archive_title_opacity != '' ) ? '<div class="opacity-medium z-index-2 bg-extra-dark-gray bg-archive-opacity-color"'.$pofo_archive_title_opacity_style.'></div>' : '';
            
            $pofo_poster_image = ( $pofo_image_url[0] ) ? ' poster="'.esc_url( $pofo_image_url[0] ).'"': '';
        
            echo '<section class="no-padding one-third-screen position-relative wow fadeIn pofo-archive-title-bg '.$pofo_archive_title_style.$pofo_archive_title_parallax.$srcset_classes.'"'.$pofo_archive_title_parallax_effect.$pofo_archive_title_bg_image.$srcset_data.'>';
                echo wp_kses_post( $pofo_archive_title_bg_image_overlay );
                echo '<div class="container">';
                    echo '<div class="row">';
                        if( $pofo_archive_title != '' || $pofo_archive_title_subtitle != ''){
                            echo '<div class="col-md-12 col-sm-12 col-xs-12 z-index-3 display-table one-third-screen page-title-medium">';
                                echo '<div class="display-table-cell vertical-align-middle text-center">';
                                    if( $pofo_archive_title_subtitle ){
                                        echo '<span class="margin-5px-bottom display-block alt-font text-medium-gray pofo-archive-subtitle">'.esc_attr( $pofo_archive_title_subtitle ).'</span>';
                                    }
                                    if( $pofo_archive_title ){
                                        echo '<h1 class="text-white alt-font font-weight-600 letter-spacing-minus-1 pofo-archive-title '.$pofo_archive_title_text_transform.'">'.esc_attr( $pofo_archive_title ).'</h1>';
                                    }
                                    if( $pofo_disable_breadcrumb == 1 ){
                ...
                if( $pofo_archive_title_video_type == 'self' && ( $pofo_archive_title_video_mp4 || $pofo_archive_title_video_ogg || $pofo_archive_title_video_webm )){
                    echo '<video autoplay'.$pofo_archive_loop_video.$pofo_archive_mute_video.' class="html-video z-index-1"'.$pofo_poster_image.'>';
                    ...
                    echo '<div class="external-fit-videos fit-videos width-100">';
                        echo '<embed width="560" height="315" src="'.$pofo_archive_title_video_youtube.'" frameborder="0" allowfullscreen></embed>';
                    echo '</div>';
                }
            echo '</section>';
        break;
        case 'page-title-style-9':
            echo '<section class="wow fadeIn bg-light-gray padding-35px-tb page-title-small pofo-archive-title-bg top-space '.$pofo_archive_title_style.'">';
                echo '<div class="container">';
                    echo '<div class="row equalize sm-equalize-auto">';
                        if( $pofo_archive_title != '' ){
                            echo '<div class="col-lg-7 col-md-6 col-sm-12 col-xs-12 display-table">';
                    ...
                    echo '<div class="row">';
                        if( $pofo_archive_title != '' || $pofo_archive_title_subtitle != '' ){
                            echo '<div class="col-md-12 col-sm-12 col-xs-12 extra-small-screen display-table page-title-large">';
                                echo '<div class="display-table-cell vertical-align-middle text-center">';
                                    if( $pofo_archive_title ){
                                        echo '<h1 class="text-white alt-font font-weight-600 letter-spacing-minus-1 margin-10px-bottom pofo-archive-title '.$pofo_archive_title_text_transform.'">'.esc_attr( $pofo_archive_title ).'</h1>';
                                    }
                                    if( $pofo_archive_title_subtitle ){
                                        echo '<span class="text-white alt-font margin-15px-bottom pofo-archive-subtitle display-block opacity6">'.esc_attr( $pofo_archive_title_subtitle ).'</span>';
                                    }
                                echo '</div>';
                            echo '</div>';
                        }
