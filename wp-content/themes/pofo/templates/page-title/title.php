...
if ( !defined( 'ABSPATH' ) ) { exit; }
    ...
    if( is_singular('post') || is_singular('portfolio') || is_singular( 'attachment' ) ){
        return;
    }
    ...
    $pofo_image = pofo_get_image_id_by_url( pofo_option('pofo_page_title_bg_image',''));
    ...
    if( $pofo_disable_page_title_image == 1 || $pofo_disable_page_title_image == '' ){
        ...
        $pofo_page_title_bg_image = ( $pofo_image_url[0] ) ? ' style="background-image: url('.esc_url( $pofo_image_url[0] ).'); background-repeat: no-repeat; "': '';
        
        $parallax_effect = pofo_option('pofo_page_title_parallax_effect', '0.5');
        $pofo_page_title_parallax_effect = ( !empty( $parallax_effect ) && $parallax_effect != 'no-parallax' ) ? ' data-stellar-background-ratio="'.$parallax_effect.'"': '';
    ...
    switch ( $pofo_page_title_style ) {
        case 'page-title-style-1':
            echo '<section class="wow fadeIn bg-light-gray padding-50px-tb xs-padding-30px-tb page-title-small pofo-page-title-bg top-space '.$pofo_page_title_style.'">';
                echo '<div class="container">';
                    echo '<div class="row equalize sm-equalize-auto">';
                        if( $pofo_page_title != '' || $pofo_page_title_subtitle != '' ){
                            echo '<div class="col-lg-7 col-md-6 col-sm-12 col-xs-12 display-table">';
                                echo '<div class="display-table-cell vertical-align-middle text-left sm-text-center">';
                                    if( $pofo_page_title ){
                                        echo '<h1 class="alt-font text-extra-dark-gray font-weight-600 no-margin-bottom pofo-page-title '.$pofo_page_title_text_transform.'">'.esc_attr( $pofo_page_title ).'</h1>';
                                    }
                                    if( $pofo_page_title_subtitle && ( $pofo_disable_page_subtitle == 1 || $pofo_disable_page_subtitle == '' ) ){
                                        echo '<span class="display-block margin-5px-top alt-font pofo-page-subtitle">'.esc_attr( $pofo_page_title_subtitle ).'</span>';
                                    }
                                echo '</div>';
                            echo '</div>';
                        }
        ...
        case 'page-title-style-2':
            echo '<section class="wow fadeIn bg-light-gray padding-50px-tb xs-padding-30px-tb small-page-title pofo-page-title-bg top-space '.$pofo_page_title_style.'">';
                echo '<div class="container">';
                    echo '<div class="row equalize sm-equalize-auto">';
                        if( $pofo_disable_breadcrumb == 1 ){
        ...
        case 'page-title-style-3':
            echo '<section class="wow fadeIn bg-light-gray padding-100px-tb sm-padding-60px-tb xs-padding-30px-tb pofo-page-title-bg top-space '.$pofo_page_title_style.'">';
                echo '<div class="container">';
                    echo '<div class="row">';
                        if( $pofo_page_title != '' || $pofo_page_title_subtitle != '' ){
                            echo '<div class="col-md-12 col-sm-12 col-xs-12 display-table page-title-medium">';
                                echo '<div class="display-table-cell vertical-align-middle text-center">';
                                    if( $pofo_page_title ){
                                        echo '<h1 class="alt-font text-extra-dark-gray font-weight-600 no-margin pofo-page-title '.$pofo_page_title_text_transform.'">'.esc_attr( $pofo_page_title ).'</h1>';
                                    }
                                    if( $pofo_page_title_subtitle && ( $pofo_disable_page_subtitle == 1 || $pofo_disable_page_subtitle == '' ) ){
                                        echo '<span class="display-block center-col margin-10px-top alt-font pofo-page-subtitle">'.esc_attr( $pofo_page_title_subtitle ).'</span>';
                                    }
                                echo '</div>';
                            echo '</div>';
                        }
        ...
        case 'page-title-style-4':
            echo '<section class="wow fadeIn pofo-page-title-bg '.$pofo_page_title_style.$pofo_page_title_parallax.$srcset_classes.'"'.$pofo_page_title_parallax_effect.$pofo_page_title_bg_image.$srcset_data.'>';
                    ...
                    echo '<div class="row">';
                        if( $pofo_page_title != '' || $pofo_page_title_subtitle != '' ){
                            echo '<div class="col-md-12 col-sm-12 col-xs-12 display-table extra-small-screen page-title-medium center-col">';
                                echo '<div class="display-table-cell vertical-align-middle text-center">';
                                    if( $pofo_page_title ){
                                        echo '<h1 class="alt-font text-white font-weight-600 no-margin letter-spacing-1 pofo-page-title '.$pofo_page_title_text_transform.'">'.esc_attr( $pofo_page_title ).'</h1>';
                                    }
                                    if( $pofo_page_title_subtitle && ( $pofo_disable_page_subtitle == 1 || $pofo_disable_page_subtitle == '' ) ){
                                        echo '<span class="display-block margin-10px-top text-extra-small alt-font pofo-page-subtitle">'.esc_attr( $pofo_page_title_subtitle ).'</span>';
                                    }
                                echo '</div>';
                            echo '</div>';
                        }
        ...
        case 'page-title-style-5':
            echo '<section class="wow fadeIn bg-extra-dark-gray pofo-page-title-bg '.$pofo_page_title_style.$pofo_page_title_parallax.$srcset_classes.'"'.$pofo_page_title_parallax_effect.$pofo_page_title_bg_image.$srcset_data.'>';
                echo wp_kses_post( $pofo_page_title_bg_image_overlay );
                echo '<div class="container">';
                    echo '<div class="row">';
                        if( $pofo_page_title != '' || $pofo_page_title_subtitle != '' ){
                            echo '<div class="col-md-12 col-sm-12 col-xs-12 extra-small-screen display-table page-title-extra-small">';
                                echo '<div class="display-table-cell vertical-align-middle text-center">';
                                    if( $pofo_page_title ){
                                        echo '<h1 class="alt-font text-white opacity7 margin-10px-bottom pofo-page-title '.$pofo_page_title_text_transform.'">'.esc_attr( $pofo_page_title ).'</h1>';
                                    }
                                    if( $pofo_page_title_subtitle && ( $pofo_disable_page_subtitle == 1 || $pofo_disable_page_subtitle == '' ) ){
                                        echo '<h2 class="text-white alt-font font-weight-600 width-55 sm-width-65 center-col xs-width-100 letter-spacing-minus-1 line-height-50 sm-line-height-45 xs-line-height-30 pofo-page-subtitle">'.esc_attr( $pofo_page_title_subtitle ).'</h2>';
                                    }
                                echo '</div>';
                            echo '</div>';
                        }
        ...
        case 'page-title-style-6':
            echo '<section class="wow fadeIn pofo-page-title-bg top-space '.$pofo_page_title_style.$pofo_page_title_parallax.$srcset_classes.'"'.$pofo_page_title_parallax_effect.$pofo_page_title_bg_image.$srcset_data.'>';
                echo wp_kses_post( $pofo_page_title_bg_image_overlay );
                echo '<div class="container">';
                    echo '<div class="row">';
                    if( $pofo_page_title != '' || $pofo_page_title_subtitle != '' ){
                        echo '<div class="col-md-12 col-sm-12 col-xs-12 display-table page-title-large">';
                            echo '<div class="display-table-cell vertical-align-middle text-center padding-30px-tb">';
                                if( $pofo_page_title_subtitle && ( $pofo_disable_page_subtitle == 1 || $pofo_disable_page_subtitle == '' ) ){
                                    echo '<span class="display-block text-white opacity6 alt-font margin-5px-bottom pofo-page-subtitle">'.esc_attr( $pofo_page_title_subtitle ).'</span>';
                                }
                                if( $pofo_page_title ){
                                    echo '<h1 class="alt-font text-white font-weight-600 no-margin-bottom pofo-page-title '.$pofo_page_title_text_transform.'">'.esc_attr( $pofo_page_title ).'</h1>';
                                }
                            echo '</div>';
                        echo '</div>';
                    }
        ...
        case 'page-title-style-7':
            ...
            echo '<section class="no-padding one-third-screen position-relative wow fadeIn pofo-page-title-bg '.$pofo_page_title_style.'">';
                echo wp_kses_post( $pofo_page_title_bg_image_overlay );
                echo '<div class="container">';
                    echo '<div class="row">';
                        if( $pofo_page_title != '' || $pofo_page_title_subtitle != '' ){
                            echo '<div class="col-md-12 col-sm-12 col-xs-12 display-table one-third-screen z-index-2 page-title-large">';
                                echo '<div class="display-table-cell vertical-align-middle text-center">';
                                    if( $pofo_page_title_subtitle && ( $pofo_disable_page_subtitle == 1 || $pofo_disable_page_subtitle == '' ) ){
                                        echo '<span class="display-block text-white opacity6 margin-10px-bottom alt-font pofo-page-subtitle">'.esc_attr( $pofo_page_title_subtitle ).'</span>';
                                    }
                                    if( $pofo_page_title ){
                                        echo '<h1 class="alt-font text-white font-weight-600 width-55 sm-width-80 xs-width-100 center-col no-margin-bottom pofo-page-title '.$pofo_page_title_text_transform.'">'.esc_attr( $pofo_page_title ).'</h1>';
                                    }
                                echo '</div>';
                            echo '</div>';
                        }
        ...
        case 'page-title-style-8':
            ...
            echo '<section class="no-padding one-third-screen position-relative wow fadeIn pofo-page-title-bg '.$pofo_page_title_style.$pofo_page_title_parallax.$srcset_classes.'"'.$pofo_page_title_parallax_effect.$pofo_page_title_bg_image.$srcset_data.'>';
                echo wp_kses_post( $pofo_page_title_bg_image_overlay );
                echo '<div class="container">';
                    echo '<div class="row">';
                        if( $pofo_page_title != '' || $pofo_page_title_subtitle != ''){
                            echo '<div class="col-md-12 col-sm-12 col-xs-12 z-index-3 display-table one-third-screen page-title-medium">';
                                echo '<div class="display-table-cell vertical-align-middle text-center">';
                                    if( $pofo_page_title_subtitle && ( $pofo_disable_page_subtitle == 1 || $pofo_disable_page_subtitle == '' ) ){
                                        echo '<span class="margin-5px-bottom display-block alt-font text-medium-gray pofo-page-subtitle">'.esc_attr( $pofo_page_title_subtitle ).'</span>';
                                    }
                                    if( $pofo_page_title ){
                                        echo '<h1 class="text-white alt-font font-weight-600 letter-spacing-minus-1 pofo-page-title '.$pofo_page_title_text_transform.'">'.esc_attr( $pofo_page_title ).'</h1>';
                                    }
                                    if( $pofo_disable_breadcrumb == 1 ){
                ...
                if( $pofo_page_title_video_type == 'self' && ( $pofo_page_title_video_mp4 || $pofo_page_title_video_ogg || $pofo_page_title_video_webm )){
                    echo '<video autoplay'.$pofo_page_loop_video.$pofo_page_mute_video.' class="html-video z-index-1"'.$pofo_poster_image.'>';
                    ...
                    echo '<div class="external-fit-videos fit-videos width-100">';
                        echo '<embed width="560" height="315" src="'.$pofo_page_title_video_youtube.'" frameborder="0" allowfullscreen></embed>';
                    echo '</div>';
                }
            echo '</section>';
        break;
        case 'page-title-style-9':
            echo '<section class="wow fadeIn bg-light-gray padding-35px-tb page-title-small pofo-page-title-bg top-space '.$pofo_page_title_style.'">';
                echo '<div class="container">';
                    echo '<div class="row equalize sm-equalize-auto">';
                        if( $pofo_page_title != '' ){
                            echo '<div class="col-lg-7 col-md-6 col-sm-12 col-xs-12 display-table">';
                    ...
                    echo '<div class="row">';
                        if( $pofo_page_title != '' || $pofo_page_title_subtitle != '' ){
                            echo '<div class="col-md-12 col-sm-12 col-xs-12 extra-small-screen display-table page-title-large">';
                                echo '<div class="display-table-cell vertical-align-middle text-center">';
                                    if( $pofo_page_title ){
                                        echo '<h1 class="text-white alt-font font-weight-600 letter-spacing-minus-1 margin-10px-bottom pofo-page-title '.$pofo_page_title_text_transform.'">'.esc_attr( $pofo_page_title ).'</h1>';
                                    }
                                    if( $pofo_page_title_subtitle && ( $pofo_disable_page_subtitle == 1 || $pofo_disable_page_subtitle == '' ) ){
                                        echo '<span class="text-white alt-font margin-15px-bottom pofo-page-subtitle display-block opacity6">'.esc_attr( $pofo_page_title_subtitle ).'</span>';
                                    }
                                echo '</div>';
                            echo '</div>';
                        }
